    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 13,
          name: 'Kotlin',
          imageUrl: 'https://www.vectorlogo.zone/logos/kotlinlang/kotlinlang-icon.svg',
          status: 'Beginner'
        },
        {
          id: 14,
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          ...
          src="https://iili.io/HyHnGHB.md.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everybody! My name is Dwiky Prias Marliansah. I am a web developer from Purbalingga, Central Java. I
            very enthusiastic in the world of technology if there is a new technology I try to adapt and learn about this technology.
            I really enjoy what I'm doing now, I think making a program is not just a hobby, but also an art
            own
            aesthetic value
          </p>
