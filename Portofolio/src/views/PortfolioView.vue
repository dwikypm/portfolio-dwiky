    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'Dana UI',
          imageUrl: 'dana_ui',
          status: 'A UI cloning a indonesian payment Dana - dompet digital indonesia',
          tech: 'Figma',
          github: '#',
          demo: '#'
        },
        {
          id: 3,
          name: 'Dashboard Finansial UI',
          imageUrl: 'dashboard_finansial',
          status: 'a UI dashboard to manage your finances so that they are easy to manage and can make everyday life easier',
          tech: 'Figma',
          github: 'null',
          demo: 'null'
        }
